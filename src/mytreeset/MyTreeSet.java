    ...
    public class MyTreeSet<T> {
        ...
        private void add(Node<T> addTo, Node<T> newNode) {
            ...
            Comparable addToComparable;
            Comparable newNodeComparable;
            int compare = 0;

            try {
                addToComparable = (Comparable) addToObject;
                newNodeComparable = (Comparable) newNodeObject;
                compare = addToComparable.compareTo(newNodeComparable);
            } catch (ClassCastException e) {
                System.err.println("ClassCastException: unable to add");
                e.printStackTrace(System.err);
                System.exit(1);
            } catch (NullPointerException e) {
                System.err.println("NullPointerException: unable to add");
                e.printStackTrace(System.err);
                System.exit(1);
            } catch (Exception e){
                System.err.print("Other exception");
                e.printStackTrace(System.err);
                System.exit(1);
            }
        ...
        private static class Node<T> implements Comparable<T> {
            ...
            public int compareTo(Object o) {
                ...
                Comparable thisDataComparable;
                int compare = 0;

                try {
                    comparableObject = (Comparable) o;
                    thisDataComparable = (Comparable) this.getData();
                    compare = thisDataComparable.compareTo(comparableObject);
                } catch (NullPointerException e) {
                    System.err.println("NullPointerException: unable to compare");
                    e.printStackTrace(System.err);
                    System.exit(1);
                } catch (ClassCastException e){
                    System.err.println("ClassCastException: unable to compare");
                    e.printStackTrace(System.err);
                    System.exit(1);
                }
